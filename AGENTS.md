...
is bound by the contract below. The boundaries are enforced by 370 tests across 32
...
**Current verification state: 370 tests passing across 32 suites (+ coupled/uncoupled parity proof).**
