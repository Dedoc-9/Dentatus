...
is bound by the contract below. The boundaries are enforced by 353 tests across 32
...
**Current verification state: 353 tests passing across 32 suites (+ coupled/uncoupled parity proof).**
