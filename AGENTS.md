...
is bound by the contract below. The boundaries are enforced by 487 tests across 36
...
**Current verification state: 487 tests passing across 36 suites (+ coupled/uncoupled parity proof).**
...
VERSION: 29-component / 27-sibling / 36-suite / 487-test workbench (+ parity proof)
```
