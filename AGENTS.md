...
is bound by the contract below. The boundaries are enforced by 387 tests across 33
...
**Current verification state: 387 tests passing across 33 suites (+ coupled/uncoupled parity proof).**
